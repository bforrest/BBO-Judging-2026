...
Input files (must be in same directory):
    - Judges_and_Tables_generated.csv: Judge assignments and entries
...
# Open the CSV file containing judge assignments (generated by generate_judges_and_tables.py)
with open("Judges_and_Tables_generated.csv", 'r', encoding='utf-8') as f:
    # Use default comma delimiter; header row is the first line
    reader = csv.DictReader(f)
