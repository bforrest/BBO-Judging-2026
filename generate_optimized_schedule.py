...
.rank-3 { background: #2196f3bf; color: white; }
.rank-4 { background: #9c27b0a3; color: white; }

/* Conflict and warning badges */
.conflict { border: 3px solid #dc3545; background: #fff5f5; }
.conflict-badge { background: #dc3545; color: white; padding: 2px 6px; border-radius: 3px; font-size: 11px; margin-left: 5px; float: right; }
.workload-warning { border: 3px solid #ff9800; background: #fff8e1; }
.workload-badge { background: #ff9800; color: white; padding: 3px 8px; border-radius: 3px; font-size: 12px; font-weight: bold; margin-bottom: 8px; display: inline-block; float: right; }
...
/* Badges */
.pairing { background: #6c757d; color: white; padding: 2px 6px; border-radius: 3px; font-size: 10px; margin-left: 4px; float: right; }
.conflict-badge { background: #dc3545; color: white; padding: 2px 5px; border-radius: 3px; font-size: 10px; margin-left: 4px; float: right; }
